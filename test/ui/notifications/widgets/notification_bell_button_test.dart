...
void main() {
  ...
  testWidgets(
    'mostra la campanella senza badge quando non ci sono notifiche non lette',
    (WidgetTester tester) async {
      await tester.pumpWidget(
        buildTestWidget(unreadCount: 0, isPanelOpen: false, onPressed: () {}),
      );
  ...
  testWidgets('mostra il badge con il numero di notifiche non lette', (
    ...
    await tester.pumpWidget(
      buildTestWidget(unreadCount: 3, isPanelOpen: false, onPressed: () {}),
    );
  ...
  testWidgets('mostra 9+ quando le notifiche non lette superano 9', (
    ...
    await tester.pumpWidget(
      buildTestWidget(unreadCount: 12, isPanelOpen: false, onPressed: () {}),
    );
