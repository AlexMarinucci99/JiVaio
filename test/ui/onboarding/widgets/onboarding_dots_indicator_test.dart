...
void main() {
  Widget buildTestWidget({required int currentIndex, required int itemCount}) {
    return MaterialApp(
      home: Scaffold(
        body: Center(
  ...
  testWidgets('mostra un pallino per ogni slide', (WidgetTester tester) async {
    await tester.pumpWidget(buildTestWidget(currentIndex: 0, itemCount: 3));
  ...
  testWidgets('rende più largo il terzo pallino quando currentIndex è 2', (
    ...
    await tester.pumpWidget(buildTestWidget(currentIndex: 2, itemCount: 3));
  ...
  testWidgets('non mostra pallini quando itemCount è zero', (
    ...
    await tester.pumpWidget(buildTestWidget(currentIndex: 0, itemCount: 0));
