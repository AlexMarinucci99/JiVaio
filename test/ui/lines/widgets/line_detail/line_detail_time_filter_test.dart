...
void main() {
  ...
  testWidgets('restituisce selezione automatica quando si conferma Automatico',
      (WidgetTester tester) async {
  ...
  testWidgets('restituisce fascia manuale quando viene selezionata e confermata',
    (WidgetTester tester) async {
  LineDetailTimeSelection? selectedResult;
